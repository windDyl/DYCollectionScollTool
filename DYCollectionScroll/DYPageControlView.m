...
#define ADPageControlViewDotViewDefaultColor [UIColor blueColor]
#define ADPageControlViewCurrentDotViewColor [UIColor redColor]


@interface DYPageControlView()
...
@implementation DYPageControlView
...
{
    DYPageControlView *pageControlView = [[DYPageControlView alloc] initWithFrame:frame];
